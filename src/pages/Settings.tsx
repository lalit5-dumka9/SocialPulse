...
const Settings: React.FC = () => {
  ...
  const handleProfileSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Here we'd implement actual profile update logic
  ...
  const handlePasswordSubmit = (e: React.FormEvent) => {
    ...
    // Here we'd implement actual password change logic
  ...
  const handleDeleteAccount = () => {
    ...
    // Here we'd implement actual account deletion logic
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-5 gap-2">
                {['#1D4ED8', '#7C3AED', '#EC4899', '#F97316', '#10B981'].map((color) => (
                  <button
                    key={color}
                    className="h-10 w-10 rounded-full border-2 border-gray-200 dark:border-gray-700 hover:opacity-80 transition-opacity focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary dark:focus:ring-offset-gray-900"
                    style={{ backgroundColor: color }}
                    aria-label={`Set color theme to ${color}`}
                  />
                ))}
              </div>
            </div>
